...
THIRD_PARTY_APPS = (
    ...
    'dynamic_scraper', # for scraping websites
)
...
if DEBUG:
    ...
    DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL',
            'moocminder <moocminder-noreply@moocminder.com>')
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
    EMAIL_HOST = os.environ.get('EMAIL_HOST', 'smtp.sendgrid.com')
    EMAIL_HOST_PASSWORD = os.environ.get('SENDGRID_PASSWORD', '')
    EMAIL_HOST_USER = os.environ.get('SENDGRID_USERNAME', '')
    EMAIL_PORT = os.environ.get('EMAIL_PORT', 587)
    EMAIL_SUBJECT_PREFIX = os.environ.get('EMAIL_SUBJECT_PREFIX', '[moocminder] ')
    EMAIL_USE_TLS = True
...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "moocminder.config.settings") #Changed in DDS v.0.3
